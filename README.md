...
>from  both frontend  and backend folder used to create dockerfile for build image

>these image are push to docker Hub

>write docker-compose and build container

>check ip------content available
